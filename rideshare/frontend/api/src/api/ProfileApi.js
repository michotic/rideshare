...
export default class ProfileApi {
    ...
    */
    ...
    /**
     * @param {String} username A unique value identifying this profile.
     ...
     */
    profileDestroy(username, callback) {
      let postBody = null;
      // verify the required parameter 'username' is set
      if (username === undefined || username === null) {
        throw new Error("Missing the required parameter 'username' when calling profileDestroy");
      }
     ...
     * data is of type: {@link module:model/Profile}
     */
    profilePartialUpdate(username, opts, callback) {
      opts = opts || {};
      let postBody = opts['patchedProfile'];
      // verify the required parameter 'username' is set
      if (username === undefined || username === null) {
        throw new Error("Missing the required parameter 'username' when calling profilePartialUpdate");
      }
     ...
     * data is of type: {@link module:model/Profile}
     */
    profileRetrieve(username, callback) {
      let postBody = null;
      // verify the required parameter 'username' is set
      if (username === undefined || username === null) {
        throw new Error("Missing the required parameter 'username' when calling profileRetrieve");
      }
     ...
     * data is of type: {@link module:model/Profile}
     */
    profileUpdate(username, profile, callback) {
      let postBody = profile;
      // verify the required parameter 'username' is set
      if (username === undefined || username === null) {
        throw new Error("Missing the required parameter 'username' when calling profileUpdate");
      }
      // verify the required parameter 'profile' is set
      if (profile === undefined || profile === null) {
